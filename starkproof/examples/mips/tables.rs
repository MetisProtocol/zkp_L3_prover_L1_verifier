...
impl MipsColumn for ProcessorBaseColumn {
...
impl MipsColumn for MemoryBaseColumn {
...
impl MipsColumn for InstructionBaseColumn {
...
impl MipsColumn for InputBaseColumn {
...
impl MipsColumn for OutputBaseColumn {
    const FIRST_TRACE_COL_INDEX: usize = InputBaseColumn::LAST_TRACE_COL_INDEX + 1;
    const LAST_TRACE_COL_INDEX: usize = Self::FIRST_TRACE_COL_INDEX + Self::Value as usize;
}

impl MipsColumn for ProcessorExtensionColumn {
...
impl MipsColumn for MemoryExtensionColumn {
...
impl MipsColumn for InstructionExtensionColumn {
...
impl MipsColumn for InputExtensionColumn {
...
impl MipsColumn for OutputExtensionColumn {
